...
import { Crown, Clock, AlertTriangle, Sparkles, Trophy, Sparkle } from 'lucide-react';
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex animate-fade-in items-center justify-center overflow-y-auto bg-[#0b0518] p-4 py-10">
      ...
      <div className="relative flex w-full max-w-lg flex-col items-center text-center">
        ...
        <p className="mt-2 text-sm font-medium text-amber-100/70">
          You've conquered the ultimate Sudoku challenge.
        </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-amber-100/60">{achievement.description}</p>
                    </div>
                  </div>
                );
              })}
        ...
        <div className="mt-7 grid w-full gap-2">
          ...
          >
            <Sparkles size={18} /> Solve Another Grandmaster
          </button>
